...
class _RecurrentExpenseScreenState extends State<RecurrentExpenseScreen> {
  ...
  Future<void> _loadCategories() async {
    final categoryList = await CategoryService().getAllCategoriesAvaliable();
    setState(() {
      availableCategories = categoryList.sublist(0, categoryList.length - 1);
    });
  }

  Future<void> _loadFixedExpenses() async {
    final expenses = await FixedExpensesService.getSortedFixedExpenses();
    setState(() {
  ...
  Future<void> _saveExpense() async {
    ...
    await FixedExpensesService.addCard(FixedExpense(
      ...
      date: selectedDate,
      category: availableCategories[selectedCategoryIndex],
      id: const Uuid().v4(),
                ...
                child: Column(
                  children: [
                    FormSection(
                      ...
                      icons_list_recorrent: availableCategories,
